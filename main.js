...
infos_get('https://api.nasa.gov/insight_weather/?api_key=UWtB23fwdeREqFp4mpbpd7quIuO8KXzRvaeclwRT&feedtype=json&ver=1.0', function(data) {
    ...
    var max_temp = actual_sol_AT['mx'];
    var min_temp = actual_sol_AT['mn'];
    document.getElementById('max-1').innerHTML = max_temp + "°C";
    document.getElementById('min-1').innerHTML = min_temp + "°C";
    var actual_sol = Object.keys(data)[2];
    var actual_sol = data[actual_sol];
    var actual_sol_AT = actual_sol['AT'];
    var max_temp = actual_sol_AT['mx'];
    var min_temp = actual_sol_AT['mn'];
    document.getElementById('max-2').innerHTML = max_temp + "°C";
    document.getElementById('min-2').innerHTML = min_temp + "°C";
    var actual_sol = Object.keys(data)[3];
    var actual_sol = data[actual_sol];
    var actual_sol_AT = actual_sol['AT'];
    var max_temp = actual_sol_AT['mx'];
    var min_temp = actual_sol_AT['mn'];
    document.getElementById('max-3').innerHTML = max_temp + "°C";
    document.getElementById('min-3').innerHTML = min_temp + "°C";
    var actual_sol = Object.keys(data)[4];
    var actual_sol = data[actual_sol];
    var actual_sol_AT = actual_sol['AT'];
    var max_temp = actual_sol_AT['mx'];
    var min_temp = actual_sol_AT['mn'];
    document.getElementById('max-4').innerHTML = max_temp + "°C";
    document.getElementById('min-4').innerHTML = min_temp + "°C";
  });
